...
class TTSServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateSpeech = channel.unary_unary(
                '/tts.TTSService/GenerateSpeech',
                request_serializer=tts__pb2.TTSRequest.SerializeToString,
                response_deserializer=tts__pb2.TTSResponse.FromString,
                _registered_method=True)
        self.GenerateSpeechBase64 = channel.unary_unary(
                '/tts.TTSService/GenerateSpeechBase64',
                request_serializer=tts__pb2.TTSRequest.SerializeToString,
                response_deserializer=tts__pb2.TTSBase64Response.FromString,
                _registered_method=True)
...
class TTSServiceServicer(object):
    ...
    def GenerateSpeechBase64(self, request, context):
        """← ADD THIS LINE
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_TTSServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GenerateSpeechBase64': grpc.unary_unary_rpc_method_handler(
                    servicer.GenerateSpeechBase64,
                    request_deserializer=tts__pb2.TTSRequest.FromString,
                    response_serializer=tts__pb2.TTSBase64Response.SerializeToString,
            ),
    }
...
class TTSService(object):
    ...
    @staticmethod
    def GenerateSpeechBase64(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/tts.TTSService/GenerateSpeechBase64',
            tts__pb2.TTSRequest.SerializeToString,
            tts__pb2.TTSBase64Response.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
